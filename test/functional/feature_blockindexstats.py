...
class BlockIndexStatsTest(protonTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 PRO "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 PRO + 9 notes of 5 PRO + 1 note of 4 PRO (using 1.0 fee)
