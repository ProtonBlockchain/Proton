#!/usr/bin/env python3
# Copyright (c) 2020 The Proton developers
...
class SaplingMempoolTest(protonTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 PRO note to Alice
        ...
        # miner sends another 10 PRO note to Alice
