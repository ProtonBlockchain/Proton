...
from test_framework.test_framework import protonTier2TestFramework
...
class MasternodeGovernanceBasicTest(protonTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.proton.org/t/test-proposal"
