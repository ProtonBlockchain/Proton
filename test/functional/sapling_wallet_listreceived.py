...
class ListReceivedTest (protonTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 PRO.
        ...
        # Send 1 PRO to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 PRO sending them all (fee is 0.1 PRO)
        ...
        # Confirm transaction (2 PRO from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 PRO, send 0.6 PRO + 0.05 PRO fee
