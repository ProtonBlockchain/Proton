...
The Proton project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/proton-project/proton/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Proton project, and is not to be
confused with overall Proton Network Protocol consensus changes.

Whether a pull request is merged into Proton rests with the project merge
...
Patches that change Proton consensus rules are considerably more involved than
...
Where a patchset proposes to change the Proton consensus, it must have been
...
The project leader is the release manager for each Proton release.
