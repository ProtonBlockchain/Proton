...
The script [extract-osx-sdk.sh](https://github.com/proton-project/proton/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
proton/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/proton-project/proton/blob/master/doc/README_osx.md) for troubleshooting tips.
