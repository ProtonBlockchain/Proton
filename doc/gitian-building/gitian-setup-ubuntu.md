...
The build script we'll be using is contained in the Proton github repository ([contrib/gitian-build.py](https://github.com/proton-project/proton/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Proton repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Proton-Project/Proton/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, proton-detached-sigs, and proton GitHub repos.
