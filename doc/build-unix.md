UNIX BUILD NOTES
====================
Some notes on how to build Proton in Unix.

Note
---------------------
Always use absolute paths to configure and compile Proton and the dependencies,
...
memory available when compiling Proton. On systems with less, gcc can be
 ...
 **For Ubuntu only:** db4.8 packages are available [here](https://launchpad.net/~proton/+archive/proton).
 You can add the repository using the following command:

    sudo apt-get install software-properties-common
    sudo add-apt-repository ppa:proton/proton
    sudo apt-get update
...
To build Proton without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Proton should be built with a non-executable stack
