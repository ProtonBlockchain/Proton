...
This document provides guidelines for internationalization of the Proton software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `proton_en.ts` remains unchanged.
