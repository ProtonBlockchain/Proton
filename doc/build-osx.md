...
1. Clone the Proton source code:

        git clone https://github.com/proton-project/proton
        cd proton
...
When the intention is to run only a P2P node without a wallet, Proton may be compiled in
...
Proton is now available at `./src/protond`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/Proton"

    touch "/Users/${USER}/Library/Application Support/Proton/proton.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Proton/proton.conf"

The first time you run protond, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/Proton/debug.log

Other commands:
-------

    ./src/protond -daemon # Starts the proton daemon.
    ./src/proton-cli --help # Outputs a list of command-line options.
    ./src/proton-cli help # Outputs a list of RPC commands when the daemon is running.
