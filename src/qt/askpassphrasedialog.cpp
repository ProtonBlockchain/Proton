...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            ProtonGUI* window = static_cast<ProtonGUI*>(parentWidget());
...
{
    ProtonGUI* gui = static_cast<ProtonGUI*>(parentWidget());
...
{
    hide();
    static_cast<ProtonGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Proton will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your PROs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
