...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, ProtonGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, ProtonGUI* gui, double posX = 3);
