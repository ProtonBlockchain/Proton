...
#include "qt/proton/sendcustomfeedialog.h"
#include "qt/proton/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(ProtonGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &ProtonGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
