...
#include "qt/proton/forms/ui_coldstakingwidget.h"
#include "qt/proton/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/proton/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(ProtonGUI* parent) :
    PWidget(parent),
