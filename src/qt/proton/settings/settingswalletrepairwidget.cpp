...
#include "qt/proton/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/proton/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ProtonGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ProtonGUI::handleRestart()
