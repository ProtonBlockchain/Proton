...
#include "qt/proton/settings/forms/ui_settingsexportcsv.h"
#include <QFile>

SettingsExportCSV::SettingsExportCSV(ProtonGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
        ...
        isTxExport ? tr("Proton_tx_csv_export(*.csv)") : tr("Proton_addresses_csv_export(*.csv)"),
        nullptr);
