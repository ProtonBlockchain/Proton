...
#include "qt/proton/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/proton/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(ProtonGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
static bool PotentiallyDangerousCommand(const QString& cmd)
{
    ...
    if (cmd.size() >= 13 && cmd.leftRef(11) == "dumpprivkey") {
        // valid Proton Transparent Address
        std::vector<std::string> args;
