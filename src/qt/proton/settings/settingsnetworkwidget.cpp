...
#include "qt/proton/settings/settingsnetworkwidget.h"
#include "qt/proton/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/proton/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ProtonGUI* _window, QWidget *parent) :
