...
#include <QWidget>
#include "qt/proton/pwidget.h"
#include "qt/proton/settings/settingsbackupwallet.h"
#include "qt/proton/settings/settingsexportcsv.h"
#include "qt/proton/settings/settingsbittoolwidget.h"
#include "qt/proton/settings/settingssignmessagewidgets.h"
#include "qt/proton/settings/settingswalletrepairwidget.h"
#include "qt/proton/settings/settingswalletoptionswidget.h"
#include "qt/proton/settings/settingsmainoptionswidget.h"
#include "qt/proton/settings/settingsdisplayoptionswidget.h"
#include "qt/proton/settings/settingsmultisendwidget.h"
#include "qt/proton/settings/settingsinformationwidget.h"
#include "qt/proton/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(ProtonGUI* parent);
    ~SettingsWidget();
