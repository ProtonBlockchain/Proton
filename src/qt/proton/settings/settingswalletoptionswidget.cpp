...
#include "qt/proton/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/proton/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(ProtonGUI* _window, QWidget *parent) :
