...
#ifndef Proton_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Proton_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Proton_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
