...
#ifndef Proton_CORE_NEW_GUI_ProtonGUI_H
#define Proton_CORE_NEW_GUI_ProtonGUI_H
...
#include "qt/proton/navmenuwidget.h"
#include "qt/proton/topbar.h"
#include "qt/proton/dashboardwidget.h"
#include "qt/proton/send.h"
#include "qt/proton/receivewidget.h"
#include "qt/proton/addresseswidget.h"
#include "qt/proton/coldstakingwidget.h"
#include "qt/proton/masternodeswidget.h"
#include "qt/proton/snackbar.h"
#include "qt/proton/settings/settingswidget.h"
...
/**
  Proton GUI main class. This class represents the main window of the Proton UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ProtonGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ProtonGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~ProtonGUI();
...
#endif //Proton_CORE_NEW_GUI_ProtonGUI_H
