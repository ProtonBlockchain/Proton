...
//
// The Masternode Class. It contains the input of the Collateral Amount of PRO, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is Collateral Amount of PRO - checking if valid masternode)
