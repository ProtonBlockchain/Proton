...
RESOURCES += src/qt/proton.qrc src/qt/proton_locale.qrc

TRANSLATIONS += src/qt/locale/proton_bg.ts \
                src/qt/locale/proton_de.ts \
                src/qt/locale/proton_en.ts \
                src/qt/locale/proton_es.ts \
                src/qt/locale/proton_fi.ts \
                src/qt/locale/proton_fr.ts \
                src/qt/locale/proton_it.ts \
                src/qt/locale/proton_ja.ts \
                src/qt/locale/proton_pl.ts \
                src/qt/locale/proton_pt.ts \
                src/qt/locale/proton_ru.ts \
                src/qt/locale/proton_sk.ts \
                src/qt/locale/proton_sv.ts \
                src/qt/locale/proton_vi.ts \
                src/qt/locale/proton_zh_CN.ts \
                src/qt/locale/proton_zh_TW.ts
