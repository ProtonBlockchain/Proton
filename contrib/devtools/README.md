...
Provides utilities for managing copyright headers of `The Proton
...
Proton-Project/Proton repository.
...
Setup
---------
Configuring the github-merge tool for the Proton repository is done in the following way:

    git config githubmerge.repository Proton-Project/Proton
...
A script to optimize png files in the Proton
